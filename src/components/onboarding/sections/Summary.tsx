...
import { AddOn } from "@/stores/onboarding/slices/createAddOnSlice";
...
export default function Summary() {
  ...
  const onNext = () => {
    ...
    //save ke db personalInfo
    //save ke db organizational Info
    //save bahwa onboarding udah pernah dilakukan == true
  };
