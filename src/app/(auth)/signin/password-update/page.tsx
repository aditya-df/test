...
import { getUserByResetPasswordToken } from "@/services/user";
...
export default async function PasswordUpdatePage(
  ...
  if (searchParams.token) {
    ...
    if (!user) {
      return (
        <div className="flex min-h-screen w-full items-center justify-center">
          <Card className="max-sm:flex max-sm:h-screen max-sm:w-full max-sm:flex-col max-sm:items-center max-sm:justify-center sm:min-w-[370px] sm:max-w-[368px] shadow-none border-none bg-white dark:bg-gray-900">
            <CardHeader>
    ...
    return (
      <div className="flex min-h-screen w-full items-center justify-center">
        <Card className="max-sm:flex max-sm:h-screen max-sm:w-full max-sm:flex-col max-sm:items-center max-sm:justify-center max-sm:rounded-none max-sm:border-none sm:min-w-[370px] sm:max-w-[368px] shadow-none border-none bg-white dark:bg-gray-900">
          <CardHeader>
