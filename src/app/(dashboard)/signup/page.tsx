...
export default async function SignUpPage(): Promise<React.ReactElement> {
  ...
  return (
    <Card className="max-sm:flex max-sm:w-full max-sm:flex-col max-sm:items-center max-sm:justify-center max-sm:rounded-none max-sm:border-none sm:min-w-[370px] sm:max-w-[368px] bg-white/80 dark:bg-zinc-900/80 backdrop-blur-md border-white/20 shadow-xl">
