...
export default function NotFound() {
    return (
        <div className="mt-4 py-28 flex w-full flex-col h-[88vh] items-center justify-center text-center rounded-[10px] border border-stroke bg-white bg-[url('/images/NCI/img/bg2.webp')] bg-cover bg-no-repeat">
            <div className="mx-auto flex flex-col items-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="120" height="120" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-circle-help"><circle cx="12" cy="12" r="10" /><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3" /><path d="M12 17h.01" /></svg>
                <div className="mt-6">
